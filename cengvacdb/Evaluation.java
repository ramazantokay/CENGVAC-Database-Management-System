...
public class Evaluation {
    ...
    private static String user = "e2159390";
    private static String password = "9NJIq#0n$g86"; //  TODO: Your password
    private static String host = "144.122.71.121"; // host name
    private static String database = "db2159390"; // TODO: Your database name
    private static int port = 8080; // portZ
    ...
    public static void main(String[] args) {
        ...
        String cengvacdbDirectory = "/home/altair/Desktop/FILE_HW/source_files" + System.getProperty("file.separator") +
